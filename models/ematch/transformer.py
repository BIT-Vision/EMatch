...
class FeatureTransformer(nn.Module):
    ...
    def forward(self, feature0, feature1,
        ...
        feature0_out, feature1_out = concat0.chunk(chunks=2, dim=0)  # [B, H*W, C]

        # reshape back
        feature0 = feature0_out.view(b, h, w, c).permute(0, 3, 1, 2).contiguous()  # [B, C, H, W]
        feature1 = feature1_out.view(b, h, w, c).permute(0, 3, 1, 2).contiguous()  # [B, C, H, W]
