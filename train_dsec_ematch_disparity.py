...
def get_args_parser():
    ...
    parser.add_argument('--configs_dataset', default='./datasets/configs_dataset/ematch/disparity/dsec_train.yaml', type=str)
...
def main(args):
    ...
    while total_steps < args.num_steps:
        ...
        for i, sample in enumerate(train_loader):
            ...
            logger.add_disparity_summary(disparity_preds[-1][0], 'train/disparity_predicted')
            logger.add_disparity_summary(disparity_gt[0], 'train/disparity_gt')
